...
TRAIN_BATCH_SIZE = 2 # 訓練データのバッチサイズ
BATCH_SIZE = 16      # 検証データとテストデータのバッチサイズ
NUM_LABELS = 7       # カテゴリーの数
...
def main():
    ...
    dataset = TextClassificationDataset('./my_data', category_list, tokenizer, MAX_LENGTH)
    ...
    # ロガーの設定
    logger = TensorBoardLogger('logs', name='model1')
    ...
    model.bert_sc.save_pretrained('./model1_transformers')
